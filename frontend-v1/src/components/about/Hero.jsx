...
const Hero = () => {
  return (
    <section className="bg-transparent px-4 py-10 sm:px-6 sm:py-16 lg:py-[5.25rem]">
      <div className="mx-auto max-w-7xl">
        <div className="max-w-[760px]">
          ...
          <h1 className="mt-7 max-w-[740px] text-3xl font-bold leading-[1.08] tracking-tight text-slate-950 sm:text-5xl lg:text-[50px]">
        ...
        <div className="mt-14 grid gap-4 sm:mt-20 sm:grid-cols-2 sm:gap-5 lg:mt-[5.25rem] lg:grid-cols-4">
          {principles.map(({ title, description, icon: Icon }) => (
            <article
              key={title}
              className="surface-card min-h-[187px] px-5 py-6 transition-transform duration-200 hover:-translate-y-1 sm:px-6"
            >
